...
<!-- FOOTER -->
<footer style="text-align:center;padding:80px 24px 90px;border-top:1px solid rgba(20,16,12,.06);background:radial-gradient(ellipse at 50% 100%,#FFFFFF,var(--black))">
  <div style="font-family:'Noto Serif JP',serif;font-size:46px;color:var(--ink);margin-bottom:8px">兄弟</div>
  <div style="font-family:'Cormorant Garamond',serif;letter-spacing:.5em;color:var(--grey);font-size:17px;padding-left:.5em">KYODAI</div>
  <div style="margin-top:20px;font-family:'Cormorant Garamond',serif;font-style:italic;font-size:19px;color:var(--grey)">No buscamos clientes. Buscamos hermanos.</div>
  <div style="display:flex;justify-content:center;gap:14px;margin-top:34px;flex-wrap:wrap">
    <a href="https://www.instagram.com/kyodai.col?igsh=MXg0b2xycWUwMThsdQ%3D%3D&utm_source=qr" target="_blank" rel="noopener" aria-label="Instagram de Kyodai"
       style="display:flex;align-items:center;gap:9px;text-decoration:none;border:1px solid rgba(20,16,12,.16);padding:11px 20px;border-radius:2px;color:var(--offwhite);font-size:11px;letter-spacing:.2em;text-transform:uppercase;transition:all .3s"
       onmouseover="this.style.borderColor='#A81829';this.style.color='var(--ink)'" onmouseout="this.style.borderColor='rgba(20,16,12,.16)';this.style.color='var(--offwhite)'">
  ...
  <small style="display:block;margin-top:30px;color:var(--dim);font-size:10px;letter-spacing:.2em;text-transform:uppercase">Precios en pesos colombianos · Sabores según disponibilidad</small>
</footer>
`;
